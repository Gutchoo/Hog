...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while max(score0,score1) < goal:
        if who == 0:
            player0 = take_turn(strategy0(score0, score1), score1, dice)
            score0 += player0
            score0 += hog_pile(score0, score1)
        elif who == 1:
            player1 = take_turn(strategy1(score1, score0), score0, dice)
            score1 += player1        
...
def make_averaged(original_function, trials_count=1000):
    ...
    def average_strat(*args):
        counter = 0
        sum = 0
        while counter < trials_count:
            sum += original_function(*args)
            counter += 1
        return average(sum, trials_count)
